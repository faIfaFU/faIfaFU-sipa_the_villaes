            ...
            <form action="index.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select name="" id="tipe_villa" class="form-control">
                        ...
                        <option value="villa_jagung" <?php if($a["tipe_villa"] == "gold") echo "selected" ?>>villa_jagung</option>
...
<?php
if(isset($_post['edit'])){
    $edit= $koneksi->query("UPDATE villa set  nama_villa ='$_POST[nama_villa]', tipe_villa = '$_POST[tipe_villa]', gambar='$_POST [gambar]', lokasi ='$_POST [lokasi]',  fasilitas  ='$_POST [fasilitas]',harga ='$_POST [harga]' where kode_villa='$ed' ");
